  ...
  return (
    <>
      ...
      <div className="p-4">
        ...
        {data &&
          data
            .filter((product) => path.includes(product._id))
            .map((product) => (
              <div
                key={product._id}
                className="flex flex-col md:flex-row justify-center border border-gray-300 p-4 rounded-lg mb-4 max-w-full md:max-w-3xl m-auto"
              >
                <img
